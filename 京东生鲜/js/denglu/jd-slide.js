...
JDJRValidate.prototype = {
    ...
    ih: function () {
        ...
        if (this.params.product != "click" && this.params.product != "click-bind" && this.params.product != "suspend" && this.params.product != "bind-suspend" && this.params.product != "dsc" && this.params.product != "i-dsc") {
            var a = b;
    ...
    vi: function () {
        ...
        a.jp(a.apiServer + "/slide/g.html", {
            ...
            if (a.params.product != "click" && a.params.product != "click-bind" && a.params.product != "suspend" && a.params.product != "bind-suspend" && a.params.product != "dsc" && a.params.product != "i-dsc") {
                ...
                if (i.success == 0) {
                    if (h.params.product == "suspend") {
                        ...
                        if (h.params.product == "bind-suspend") {
                            h.params.product = i.nextVerify == "DSC_VERIFY" ? "i-dsc" : "click-bind-suspend"
                        } else {
                ...
                if (h.params.product == "dsc" || h.params.product == "i-dsc") {
                    ...
                    if (i.success == 0) {
                        ...
                        if (h.params.product == "i-dsc") {
                            h.params.product = i.nextVerify == "SLIDE_VERIFY" ? "click-bind-suspend" : "i-dsc"
                        }
                        setTimeout(function () {
                            if (h.params.product == "i-dsc") {
                    ...
                    if (i.success == 0) {
                        ...
                        if (h.params.product == "click-bind-suspend" && i.nextVerify == "DSC_VERIFY") {
                            h.params.product = i.nextVerify == "DSC_VERIFY" ? "i-dsc" : "click-bind-suspend";
                            setTimeout(function () {
                                h.ih();
                                h.warp.style.display = "block"
